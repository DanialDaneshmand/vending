...
const UserTable = () => {
  ...
  // 1. Logic for Filtering and Searching
    ...
    <div className="bg-white rounded-lg border border-gray-100 shadow-sm p-4">
      ...
      <div>
        <div className="flex items-center justify-center sm:justify-start gap-4 mb-4 ">
          {/* دکمه افزودن کاربر: فقط برای کسانی که دسترسی canCreate دارند (مثلاً لول ۱ و ۲) */}
                ...
                paginatedData.map((user: any) => (
                  ...
                  >
                    ...
                    <td className="py-4 text-center ml-4">
                      <span
                        className={`px-3 py-1 rounded-sm text-xs font-bold ${user.rColor || "bg-gray-100 text-gray-600"}`}
                      >
                        {getRoleLabel(user.role)}
                      </span>
                    </td>
                    ...
                    <td className="py-4 text-center text-gray-400">_</td>
