  ...
  return (
    <div className="bg-white rounded-lg border border-gray-100 shadow-sm p-4 flex flex-col h-full">
      <div className="flex justify-between items-center mb-6">
        ...
        <button className="flex items-center gap-1.5 px-3 py-1.5 border border-blue-600 rounded-md text-blue-600 text-xs font-bold cursor-pointer transition-all">
          افزودن بازه زمانی
